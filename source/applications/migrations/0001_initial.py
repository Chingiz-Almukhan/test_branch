    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "applicant_name",
                    models.CharField(max_length=30, verbose_name="Имя ученика"),
                ),
                (
                    "applicant_surname",
                    models.CharField(max_length=30, verbose_name="Фамилия ученика"),
                ),
                (
                    "email",
                    models.EmailField(
                ...
                (
                    "class_number",
                    models.CharField(
                        blank=True, max_length=3, null=True, verbose_name="Номер класса"
                    ),
                ),
                (
                    "shift",
                ...
                (
                    "sex",
                    models.CharField(
                        choices=[("MALE", "Er bala"), ("FEMALE", "Qyz bala")],
                        default="Undefined",
                        max_length=100,
                ...
                (
                    ...
                    models.PositiveBigIntegerField(
                        ...
                        null=True,
                        validators=[
                            applications.models.validate_length,
                ...
                (
                    ...
                    models.EmailField(
                        ...
                        max_length=254,
                        null=True,
                        verbose_name="Электронная почта родителя",
                    ),
                ),
                (
                    "address",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=250,
                        null=True,
                        verbose_name="Желательное время обучения",
                    ),
                ),
                (
                    "sum",
        ...
        migrations.AddField(
            ...
            name="subjects",
            field=models.ManyToManyField(
                blank=True, related_name="applications", to="education.subject"
            ),
        ),
    ]
