...
class Application(models.Model):
    ...
    parents_inn = models.CharField(verbose_name='ИНН родителя', null=True, blank=True, max_length=12,
                                   help_text="Вводить только цифры")
    ...
    address = models.CharField(verbose_name='Адрес проживания', max_length=200, null=True, blank=True,
                               help_text=_("Вводить через запятую: населенный пункт, улица, номер дома, номер квартиры"))
    ...
    contract = models.FileField(verbose_name="Подписанный договор", null=True, blank=True,
                                help_text=_("Загружать pdf подписанного договора"), upload_to='contracts/')
    contract_date = models.DateField(verbose_name='Дата контракта', null=True, blank=True, auto_now=True)
