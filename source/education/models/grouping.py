...
class Grouping(models.Model):
    ...
    def get_active_teacher(self):
        teacher = TeacherGrouping.objects.get(grouping=self, is_active=True).teacher
        return teacher
...
class StudentGrouping(models.Model):
    ...
    student = models.ForeignKey(to='accounts.Account', on_delete=models.CASCADE, related_name='student_grouping')
...
class TeacherGrouping(models.Model):
    ...
    teacher = models.ForeignKey(to='accounts.Teacher', on_delete=models.CASCADE, related_name='teacher_groupings')
